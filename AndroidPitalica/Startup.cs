        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
               ...
               defaults: new { controller = "Exams", action = "InsertExam" }
                ...
                routes.MapRoute(
                name: "AddQuestion",
                template: "Exams/AddQuestion/{examId?}",
                defaults: new { controller = "Exams", action = "AddQuestion" },
                    constraints: new { examId = new IntRouteConstraint() }
                    );
                ...
                routes.MapRoute(
               name: "InsertExamResults",
               template: "Exams/InsertExamResults",
               defaults: new { controller = "Exams", action = "InsertExamResults" }
                   );
